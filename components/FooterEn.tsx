...
export default function FooterEn() {
  // Initializes the year. If in the browser, gets the current one, otherwise uses 2026.
  ...
  // Function to ensure email opens in a new tab/window
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-slate-900 pt-8 md:flex-row">
          <p className="text-xs uppercase tracking-widest text-slate-600">
            © {year} • All rights reserved • São Paulo, Brazil
          </p>
