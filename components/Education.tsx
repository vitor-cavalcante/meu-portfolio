  ...
  const academicPath = [
    {
      ...
      period: "2021 - 2023",
      description:
        "Foco em arquitetura de software, desenvolvimento full-stack e governança de TI.",
    ...
    },
    {
      ...
      period: "2016 - 2019",
      description:
        "Base científica sólida em análise de dados, pensamento crítico e metodologias de pesquisa aplicada.",
